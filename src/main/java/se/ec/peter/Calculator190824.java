...
//metoder
    ...
    //addition
    public static void doAddition(double num1, double num2) {
        System.out.println("The result is: " + (num1 + num2));
    }
    //subtraktion
    public static void doSubtraction(double num1, double num2) {
        System.out.println("The result is: " + (num1 - num2));
    }
    //multiplikation
    public static void doMultiplication(double num1, double num2) {
        System.out.println("The result is: " + (num1 * num2));
    }
    //division
